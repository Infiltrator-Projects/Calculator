...
constexpr std::array<Unit, 135> kUnits{{
    ...
    {"psi","pressure","0.45359237*9.80665/(0.0254^2)","0.0"},{"atm","pressure","101325.0","0.0"},
    ...
    {"W","power","1.0","0.0"},{"kW","power","1000.0","0.0"},{"hp","power","550*0.3048*0.45359237*9.80665","0.0"},
    {"BTUmin","power","1055.05585262/60","0.0"},
