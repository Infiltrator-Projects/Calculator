...
- [Numerical semantics](NUMERICS.md) — evidence hierarchy, numeric representations, expression/Standard/Programmer semantics, display precision and numerical failure contracts.
