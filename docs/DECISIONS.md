...
**Rationale.** Derived display forms should not enlarge the primary keypad or cause GTK, Win32 and SwiftUI to independently re-evaluate expressions. A shared representation model also creates the correct extension point for future exact, unit, complex and symbolic domains.
