...
expect_error("");expect_error("1 / 0");expect_error("(1 + 2");expect_error("1 + foo");expect_error("2 ** 3");expect_error("1 +");expect_error("nan");expect_error("1e9999");expect_error("sqrt(-1)");expect_error("ln(0)");expect_error("acos(2)");expect_error("(-1)!");expect_error("2.5!");expect_error("171!");expect_error("madeup(1)");
